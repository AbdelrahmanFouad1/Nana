...
class AppCupertinoActivityIndicator extends StatefulWidget {
  ...
  const AppCupertinoActivityIndicator({
    super.key,
    this.animating = true,
  ...
  /// to 1.0.
  const AppCupertinoActivityIndicator.partiallyRevealed({
    super.key,
    this.radius = _kDefaultIndicatorRadius,
    this.activeColor = _kActiveTickColor,
    this.progress = 1.0,
  ...
  @override
  State<AppCupertinoActivityIndicator> createState() => _AppCupertinoActivityIndicatorState();
}

class _AppCupertinoActivityIndicatorState extends State<AppCupertinoActivityIndicator>
  ...
  @override
  void didUpdateWidget(AppCupertinoActivityIndicator oldWidget) {
